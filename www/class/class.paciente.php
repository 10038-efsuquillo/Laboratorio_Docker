        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover mb-0">
                <thead class="thead-dark">
                    <th style="color:white" class="text-center" colspan="2">DATOS DE LOS PACIENTES</th>
                </thead>
    ...
    <div class="tab" role="tabpanel">
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <tr>
                    <th colspan="8" class="text-center"><a class="btn btn-primary" href="unido.php?d=' . $d_new_final . '" class="align-middle">Nuevo</a></th>
                </tr>
                <tr>
		...
		while ($row = $res->fetch_assoc()) {
			...
			$html .= '
				<tr>
					...
					if($rol == 1){
						$html .= '
						<td><a class="btn btn-danger" href="unido.php?d=' . $d_del_final . '">Borrar</a></td>
						...
						$html .= '
						<td><a class="btn btn-outline-info" href="unido.php?d=' . $d_det_final . '">Detalle</a></td>';
					}elseif($rol == 4){
						$html .= '';
					}else{
						$html .= '';
