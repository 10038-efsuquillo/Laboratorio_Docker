...
class Consulta
{
	...
	{
		$html = '<select class="form-control form-select" name="' . $nombre . '">';
        ...
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <thead class="thead-dark">
                    <th style="color:white" class="text-center" colspan="2">DATOS DE LA CONSULTA</th>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="date" class="form-control" size="15" name="fechaConsulta" value="' . $this->fechaConsulta . '" required></td>
                    </tr>
                    <tr>
                        <td>Hora de Inicio:</td>
                        <td><input type="time" class="form-control" size="15" name="HI" value="' . $this->HI . '" required></td>
                    </tr>
                    <tr>
                        <td>Hora Final:</td>
                        <td><input type="time" class="form-control" size="15" name="HF" value="' . $this->HF . '" required></td>
                    </tr>
                    <tr>
                        <td>Diagnóstico:</td>
                        <td><input type="text" class="form-control" size="15" name="diagnostico" value="' . $this->diagnostico . '" required></td>
                    </tr>
                    <tr>
    ...
    <div class="tab" role="tabpanel">
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <tr>
                    <th colspan="9" class="text-center"><a class="btn btn-primary" href="unido.php?d=' . $d_new_final . '" class="align-middle">Nuevo</a></th>
                </tr>
                <tr>
                    <th>Paciente</th>
                    <th>Médico</th>
		...
		while ($row = $res->fetch_assoc()) {
			...
			$html .= '
				<tr>
					...
					if($rol == 1){
						$html .= '
					<td><a class="btn btn-danger disabled" href="unido.php?d=' . $d_del_final . '">Borrar</a></td>
					<td><a class="btn btn-secondary disabled" href="unido.php?d=' . $d_act_final . '">Actualizar</a></td>
					<td><a class="btn btn-info" href="unido.php?d=' . $d_det_final . '">Detalle</a></td>';
					}elseif($rol == 2){
						$html .= '
						<td><a class="btn btn-danger disabled" href="unido.php?d=' . $d_del_final . '">Borrar</a></td>
					<td><a class="btn btn-secondary " href="unido.php?d=' . $d_act_final . '">Actualizar</a></td>
					<td><a class="btn btn-info" href="unido.php?d=' . $d_det_final . '">Detalle</a></td>';
					}elseif($rol == 3){
						$html .= '
						<td><a class="btn btn-danger disabled" href="unido.php?d=' . $d_del_final . '">Borrar</a></td>
