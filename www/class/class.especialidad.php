    ...
    <div class="tab" role="tabpanel">
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <tr>
                    <th colspan="8" class="text-center"><a class="btn btn-primary" href="unido.php?d=' . $d_new_final . '">Nuevo</a></th>
                </tr>
                <tr>
                    <th>Nº</th>
                    <th>Descripción</th>
			...
			$html .= '
				<tr>
					...
					<td><a class="btn btn-info" href="unido.php?d=' . $d_det_final . '">Detalle</a></td>';
						...
						$html .= '
					<td><a class="btn btn-primary disabled" href="unido.php?d=' . $d_det_final . '">Detalle</a></td>';
					}elseif($rol == 4){
						$html .= '';
					}else{
						$html .= '';
				...
				<div class="table-responsive">
					<table class="table table-striped mb-0">
						...
						<tbody>
							...
							<tr>
								<th class="text-center" colspan="2"><a class="btn btn-info" href="unido.php#especialidad">Regresar</a></th>
							</tr>';
