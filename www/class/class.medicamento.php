        ...
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                <thead class="thead-dark">
                    <th style="color:white" class="text-center" colspan="2">DATOS DE LOS MEDICAMENTOS</th>
                </thead>
		...
		while ($row = $res->fetch_assoc()) {
			...
			$html .= '
				<tr>
					...
					if($rol == 1){
						$html .= '
					<td><a class="btn btn-sucess " href="unido.php?d=' . $d_del_final . '">Borrar</a></td>
    ...
    <div class="table-responsive">
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <th class="text-center"><a class="btn btn-info" href="unido.php">Regresar</a></th>
                </tr>
            </tbody>
        </table>
    </div>
