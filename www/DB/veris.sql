...
-- Tiempo de generación: 18-12-2023 a las 06:54:30
...
-- Base de datos: `veris`
--
CREATE DATABASE IF NOT EXISTS `veris` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci;
USE `veris`;
...
(2, 'Juan Garcia', 1, 2, 0),
(3, 'Ana Perez', 4, 5, 0),
(4, 'Luis Quintana', 3, 9, 0),
(5, 'Julieta Armijos', 2, 10, 0),
(6, 'Dr. Manotas', 6, 11, 0);
...
(1, 3, 'Luis Torres', 1725001976, 20, 'Masculino', 198, 100, 0),
(2, 6, 'Ana Gomez', 1798456712, 70, 'Femenino', 150, 90, 0),
(3, 7, 'Oscar Uribe', 1725001984, 80, 'Masculino', 160, 105, 0),
(4, 4, 'Alex Marquez', 1723547158, 70, 'Masculino', 195, 120, 0);
